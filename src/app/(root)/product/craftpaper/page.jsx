...
const Craftpaper_part = () => {
  ...
  // ================= DATA =================
  const craftPaperItems = [
    {
      image: "/craftimageone.jpg",
      title: "Stationery & Office Paper Inspection",
      link: "#",
    },

    {
      image: "/craftimagetwo.jpg",
      title: "Gift & Packaging Products Inspection",
      link: "#",
    },

    {
      image: "/craftimagethree.jpg",
      title: "Handmade & Craft Items Inspection",
      link: "#",
    },

    {
      image: "/craftimagefour.jpg",
      title: "Corrugated & Carton Products Inspection",
      link: "#",
    },

    {
      image: "/craftimagefive.jpg",
      title: "Printed Materials Inspection",
      link: "#",
    },

    {
      image: "/craftimagesix.jpg",
      title: "Specialty Paper Products Inspection",
      link: "#",
    },
  ];
        ...
        <div className="bg-gray-900/80">
          <Container>
            <div className="space-y-4 py-32 md:py-56">
              ...
              <p className="w-auto md:w-105 lg:w-140 text-[16px] md:text-[16px] lg:text-[18px] text-white font-normal leading-tight">
              ...
              <div>
                <Link
                  ...
                  className="relative h-12.5 w-58 inline-flex items-center justify-center overflow-hidden bg-primary text-white shadow-lg transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-third before:duration-500 before:ease-out hover:before:h-60 hover:before:w-60"
                >
      ...
      <section className="pt-12 md:pt-20">
        <Container>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 pb-12">
            {craftPaperItems.map((item, index) => (
              <div
                key={index}
